...
// Set base path for Zend framework relative to this file (go up 3 levels from Document.php to get to Zend base)
$_zendBasePath = dirname(dirname(dirname(__FILE__)));

/** Zend_Search_Lucene_Field */
require_once $_zendBasePath . '/Search/Lucene/Field.php';
...
class Zend_Search_Lucene_Document
{
    ...
    public function getField($fieldName)
    {
        if (!array_key_exists($fieldName, $this->_fields)) {
            if (!isset($_zendBasePath)) {
                $_zendBasePath = dirname(dirname(dirname(__FILE__)));
            }
            require_once $_zendBasePath . '/Search/Lucene/Exception.php';
